...
- config/policies/has/ - HAS-specific extraction rules and prompts
...
- `cd tests && uv run pytest` - Run server tests to validate the chore is complete with zero regressions
