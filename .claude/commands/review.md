...
- IMPORTANT: If the work can be validated by UI validation then (if not skip the section):
  ...
  - IMPORTANT: Take screen shots along the way to showcase the new functionality and any issues you find
    ...
    - IMPORTANT: Store screenshots using RELATIVE paths from your current working directory
    - DO NOT use `pwd` or resolve absolute paths
...
- `screenshots` should ALWAYS contain RELATIVE paths to screenshots showcasing the new functionality, regardless of success status
...
```json
{
    ...
    review_issues: [
        {
            ...
            "screenshot_path": "string - agents/<adw_id>/<agent_name>/review_img/screenshot.png",
    ...
    screenshots: [
        "string - agents/<adw_id>/<agent_name>/review_img/screenshot_showcasing_functionality.png",
        "string - agents/<adw_id>/<agent_name>/review_img/screenshot_showcasing_functionality.png",
        "...",
    ]
}