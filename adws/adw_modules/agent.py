...
def prompt_claude_code(request: AgentPromptRequest) -> AgentPromptResponse:
    ...
    try:
        ...
        # This ensures Claude Code's file operations (Edit/Write) execute in the correct context
        ...
        with open(request.output_file, "w") as output_f:
            ...
            result = subprocess.run(
                ...
                text=True,
                env=env,
                # No need to specify cwd since we already changed the process directory
            )
