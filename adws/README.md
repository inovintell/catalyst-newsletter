...
# Optional - for extraction service and Claude Code hooks only
# Note: Claude Code CLI uses its own authentication, not this key
# This key is automatically mapped to HOOKS_ANTHROPIC_API_KEY for hooks
